...
def dev_tab_labels():
    my_label = Label(dev_info_frame, text="Manish Kumar Yadav\n"
                                          "Python Internship Project\n"
                                          "manish2010028@akgec.ac.in").place(x=200, y=50)
...
distance_frame = Frame(width=600, height=400, bg="#FFFFFF")
currency_frame = Frame(width=600, height=400, bg="#FFFFFF")
length_frame= Frame(width=600, height=400, bg="#FFFFFF")
weight_frame = Frame(width=600, height=400, bg="#FFFFFF")
gui_ver_frame = Frame(width=600, height=400, bg="#FFFFFF")
dev_info_frame = Frame(width=600, height=400, bg="#FFFFFF")
